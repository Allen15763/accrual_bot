"""
Accrual Bot Streamlit UI - Main Entry Point (pip install 版)

由 accrual-bot init 產生的模板。
透過 importlib.resources 載入，不依賴相對路徑。
"""
...
with st.sidebar:
    ...
    # 版本資訊
    st.markdown("---")
    st.caption(f"Accrual Bot v{__version__}")
