...
class SPTProcurementDataLoadingStep(BaseLoadingStep):
    ...
    async def _load_reference_data(self, context: ProcessingContext) -> int:
        """
        暫時棄用:
        配置載入的字典已有採購前期底稿路徑，透過_load_single_file方法已自動導入，
        故不更新在此重工。
