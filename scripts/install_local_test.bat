...
set "LOCAL_PROJECT=C:\SEA\Accrual\prpo_bot\accrual_bot"
...
echo [2/3] 安裝 Accrual Bot (本地)...
pip install -e "%LOCAL_PROJECT%"
...
echo.
echo   Next steps:
echo   1. Double-click run.bat to launch Streamlit UI
echo   2. Delete this test folder when done
echo.
pause
exit /b 0
