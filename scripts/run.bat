...
:: Google Sheets credentials — auto-copy from shared drive
set "CRED_SRC=G:\共用雲端硬碟\INT_TWN_SEA_FN_Shared_Resources\00_Temp_Internal_share\To Allen\libraries\credentials.json"
set "CRED_DST=%ACCRUAL_BOT_WORKSPACE%\secret\credentials.json"
if exist "%CRED_SRC%" (
